     ...
     <Navbar />
          <div className="profile-page">
            <div className="profile-card">
                ...
                <a to="/">
                    <img className="profile-img" src="images/merussia-modified-min.png" alt="fullstack web developer"/>
                </a>
                <div className="profile-description">
                    ...
                    <p className="profile-content">Já se você quiser dar uma olhadinha no meu trabalho, dá uma olhada aqui no meu <a href="https://github.com/lukelupus" target="_blank" rel="noreferrer"><strong>portfólio</strong></a> ou clica no gatinho!</p> 

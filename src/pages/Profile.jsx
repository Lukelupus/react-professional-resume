          ...
          <div className="profile-page">
            <div className="profile-card">
                ...
                <div className="profile-description">
                    ...
                    <p className="profile-content">Já se você quiser dar uma olhadinha no meu trabalho, dá uma olhada aqui no meu <a href="https://github.com/lukelupus">portfólio</a> ou clica no bonquinho aqui.</p> 
